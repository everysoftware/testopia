...
def upgrade() -> None:
    ...
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('updated_at', sa.DateTime(), nullable=False),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], name=op.f('checklists_user_id_fkey'), ondelete='cascade'),
    ...
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('updated_at', sa.DateTime(), nullable=False),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], name=op.f('devices_user_id_fkey'), ondelete='cascade'),
    ...
    sa.Column('name', sa.String(), nullable=False),
    sa.Column('status', sa.Enum('PASSED', 'FAILED', 'IMPOSSIBLE', 'SKIPPED', name='taskstatus', native_enum=False), nullable=False),
    sa.Column('report_url', sa.String(), nullable=True),
    sa.Column('comment', sa.String(), nullable=True),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('updated_at', sa.DateTime(), nullable=False),
    sa.ForeignKeyConstraint(['checklist_id'], ['checklists.id'], name=op.f('tasks_checklist_id_fkey'), ondelete='cascade'),
